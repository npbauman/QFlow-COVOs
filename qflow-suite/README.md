...
| Variant | Amplitudes |
|---|---|---|---|
| **QFlow-SD** | T1, T2 (singles + doubles) |
...
multi-active-space behavior — but it's a real one: QFlow-SDTQ
converges to within `~5e-8` Hartree of the exact FCI energy on this
system, confirming the full covo-ci → qflow-suite pipeline end to end.
