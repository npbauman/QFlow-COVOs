"""
QFlow-SDTQ: singles, doubles, triples, and quadruples (T1-T4) variant
of the QFlow correlation energy method.

These functions are carried over from the original ``serial_python.py``
script with NO numerical logic changes.
"""
...
from .common import compute_phase, expm, sim_trans

# Module-level cache used by precompute_excitation_pairs_cached, exactly
# as in the original serial_python.py (module-level dict there too).
